...
function main(o, data) {
  ...
  if (opts.title) {
    $("#chart").prepend("<p class=''>" + opts.title + "</p>");
  }
...
*/
function drawSqueres(data_) {


            var data = d3.nest().key(function(d) { return d.region; }).key(function(d) { return d.subregion; }).entries(data_);
            main({title: "World Population"}, {key: "World", values: data});
